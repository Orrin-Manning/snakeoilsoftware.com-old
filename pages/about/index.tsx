    ...
    <main>
      ...
      <Container as="section">
        ...
        <Card className="text-dark p-3">
          ...
          <hr />
          <Card.Text>
            Studied computer science at the University of Texas at Arlington and
            professional physics at Texas Tech University, before dropping out
            to found Snake Oil Software.
          </Card.Text>
        </Card>
      </Container>
    </main>
